...
@section('title', 'Uniqlo - Details Product')
                            ...
                            <ul class="nav product__small__images" role="tablist">
                                <li role="presentation" class="pot-small-img active">
                                    <a href="#img-tab-1" role="tab" data-toggle="tab">
                                        <img src="{{asset('templates/template1/images/product-details/small-img/1.jpg')}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img">
                                    <a href="#img-tab-2" role="tab" data-toggle="tab">
                                        <img src="{{asset('templates/template1/images/product-details/small-img/2.jpg')}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img hidden-xs">
                                    <a href="#img-tab-3" role="tab" data-toggle="tab">
                                        <img src="{{asset('templates/template1/images/product-details/small-img/3.jpg')}}" alt="small-image">
                                    </a>
                                </li>
                                <li role="presentation" class="pot-small-img d-no">
                                    <a href="#img-tab-4" role="tab" data-toggle="tab">
                                        <img src="{{asset('templates/template1/images/product-details/small-img/4.jpg')}}" alt="small-image">
                                    </a>
                                </li>
                            </ul>
                            <!-- End Small images -->
                            <div class="product__big__images">
                                <div class="portfolio-full-image tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="img-tab-1">
                                        <img src="{{asset('templates/template1/images/product-details/big-img/1.jpg')}}" alt="full-image">
                                    </div>
                                ...
                                <div class="review__address__inner">
                                    ...
                                    <div class="pro__review">
                                        <div class="review__thumb">
                                            <img src="{{asset('templates/template1/images/review/1.jpg')}}" alt="review images">
                                        </div>
                                    ...
                                    <div class="pro__review ans">
                                        <div class="review__thumb">
                                            <img src="{{asset('templates/template1/images/review/1.jpg')}}">
                                        </div>
                                        <div class="review__details">
                                            <div class="review__info">
                                                <h4><a href="#">Gerald Barnes</a></h4>
