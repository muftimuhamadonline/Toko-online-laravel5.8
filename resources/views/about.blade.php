...
<!-- Start Bradcaump area -->
                ...
                <div class="row team__wrap clearfix mt--60">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="{{asset('templates/template1/images/team/1.jpg')}}" alt="team images">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 xmt-30">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="{{asset('templates/template1/images/team/2.jpg')}}" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-30">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="{{asset('templates/template1/images/team/4.jpg')}}" alt="team images">
                                </a>
                            </div>
                            <div class="team__bg__color"></div>
                            <div class="team__hover__info">
        ...
        <div class="htc__testimonial__area ptb--120" style="background: rgba(0, 0, 0, 0) url({{asset('templates/template1/images/bg/4.jpg')}}) no-repeat scroll center center / cover ;" data--black__overlay="6">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="testimonial__wrap owl-carousel owl-theme clearfix">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('templates/template1/images/test/client/2.jpg')}}" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                            ...
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('templates/template1/images/test/client/3.jpg')}}" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod teincidi dunt ut labore et dolore gna aliqua. Ut enim ad minim veniam,</p>
                                    <div class="test__info">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="brand__list">
                            <li><a href="#">
                                <img src="{{asset('templates/template1/images/brand/cc.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{asset('templates/template1/images/brand/nike.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{asset('templates/template1/images/brand/pnb.png')}}" alt="brand images">
                            </a></li>
                            <li><a href="#">
                                <img src="{{asset('templates/template1/images/brand/uniqlo.png')}}" alt="brand images">
                            </a></li>
